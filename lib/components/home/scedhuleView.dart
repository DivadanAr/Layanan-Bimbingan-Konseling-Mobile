...
class HeaderScedhuleView extends StatefulWidget {
  final AnimationController? animationController;
  final Animation<double>? animation;

  const HeaderScedhuleView({Key? key, this.animationController, this.animation})
      : super(key: key);

  @override
  State<HeaderScedhuleView> createState() => _HeaderScedhuleViewState();
}

class _HeaderScedhuleViewState extends State<HeaderScedhuleView> {
...
class ScedhuleView extends StatefulWidget {
  final AnimationController? animationController;
  final Animation<double>? animation;

  const ScedhuleView({Key? key, this.animationController, this.animation})
      : super(key: key);

  @override
  State<ScedhuleView> createState() => _ScedhuleViewState();
}

class _ScedhuleViewState extends State<ScedhuleView> {
  @override
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      animation: widget.animationController!,
